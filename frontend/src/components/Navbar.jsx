          ...
          {user && (
            <div className="flex items-center">
              ...
              <button
                ...
                className={`flex items-center gap-1.5 px-3 py-1.5 text-xs transition-colors cursor-pointer hover:text-[var(--text-primary)] ${activeTab === 'profile'
              ...
              <div
                className="flex items-center gap-1.5 px-3 py-1.5 font-sans text-xs cursor-default"
              ...
              <button
                ...
                className={`flex items-center gap-1.5 px-3 py-1.5 text-xs transition-colors cursor-pointer hover:text-[var(--gold)] ${activeTab === 'shop'

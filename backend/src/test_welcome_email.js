...
const { sendWelcomeEmail, generateWelcomeEmailHtml, generateWelcomeEmailText } = require('./services/emailService');
...
async function runTests() {
  ...
  try {
    ...
    // Note: With unverified custom domains in Resend test mode, resend.dev sends to delivered@resend.dev or verified emails
  ...
  try {
    // Calling sendWelcomeEmail with invalid email to verify graceful failure
